...
| ----- | ----- | ------ |
| 0: Authors/README File | Neo Sekaleli | Project author |
...
| 5. Create FileStorage class | [/models/engine/file_storage.py] [/models/_ _init_ _.py][/models/base_model.py]model.py) | Defines a class to manage persistent file storage system|
...
| 10. Console 1.0 | [console.py][/models/engine/file_storage.py]e the console and file storage system to work dynamically with all  classes update file storage |
<br>
<br>
